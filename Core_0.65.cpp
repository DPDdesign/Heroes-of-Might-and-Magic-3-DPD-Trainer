// 0.01 version - still in development, does not provide all artifacts (warm machines, misc5), nor secondary skills.
// 0.10 update - Creatures maxcap is 255, Only red player, only one map mode, the input file is generated manually.
